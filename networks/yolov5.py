...
class Detect(nn.Module):
    ...
    def __init__(self, nc=4, anchors=(), ch=(), inplace=True, stride=None):  # detection layer
        super().__init__()
        self.stride = stride
...
class YOLOv5Model(nn.Module):
    def __init__(self, model_type = 'l', nc=4, *args, **kwargs) -> None:
        ...
        self.detect = Detect(nc=nc, anchors=[[10,13, 16,30, 33,23], [30,61, 62,45, 59,119], [116,90, 156,198, 373,326]], ch=[ch[2], ch[3], ch[4]], stride=[8, 16, 32])
