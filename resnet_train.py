...
def train_val(cfg):
    ...
    plt.savefig('val_loss(%d,%f).png'%(cfg.epochs, cfg.learning_rate))
    # plt.show()
    # plt.clf()
...
def parse_cfg():
    ...
    parser.add_argument('--train-data', type=str, default='data/simulator/Dataset/VehicleData.txt', help='data path')
